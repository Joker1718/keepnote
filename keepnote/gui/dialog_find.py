        ...
        self.find_xml.signal_autoconnect(
            {
                ...
                "on_replace_all_button_clicked": lambda w: self.on_find_response(
                    "replace_all"
                ),
                "on_replace_checkbutton_toggled": lambda w: (
                    self.on_find_replace_toggled()
                ),
            }
        )
