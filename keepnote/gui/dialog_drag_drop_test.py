...
class DragDropTestDialog:
    ...
    def on_drag_and_drop_test_data(
        self, textview, drag_context, x, y, selection_data, info, eventtime
    ):
        ...
        buf.insert_at_cursor(
            "type(sel.data) = " + str(type(selection_data.data)) + "\n"
        )
    ...
    def on_drag_and_drop_test_contents(self, clipboard, selection_data, data):
        ...
        buf.insert_at_cursor(
            "sel.targets = " + repr(selection_data.get_targets()) + "\n"
        )
