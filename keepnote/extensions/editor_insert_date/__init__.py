...
class Extension(extension.Extension):
    ...
    def on_add_ui(self, window):
        ...
        # add menu options
        self.add_action(
            window, "Insert Date", "Insert _Date", lambda w: self.insert_date(window)
        )
    ...
    def on_add_options_ui(self, dialog):
        ...
        dialog.add_section(
            EditorInsertDateSection("editor_insert_date", dialog, self._app, self),
            "extensions",
        )
...
class EditorInsertDateSection(dialog_app_options.Section):
    ...
    def __init__(self, key, dialog, app, ext, label="Editor Insert Date", icon=None):
